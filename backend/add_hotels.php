...
$sqlHotel="INSERT INTO tbl_hote_det (v_id,h_name,check_in_date,check_out_date,room_type,board_basis,free_cancellation_date_deadline,buy_amount,sell_amount,b_id)
      VALUES ('$v_id ','$c_hotel_name','$check_in_date','$check_out_date','$c_room_type','$c_board_basis','$free_c_deadline','$b_ammount','$s_ammount','$b_id')";
