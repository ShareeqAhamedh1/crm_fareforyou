...
$closing_ballance=0;
    ...
    for ($i=0; $i < ; $i++) {
      $sqlBookingsSelected = "SELECT * FROM tbl_booking WHERE booked_date_time ='$Date' AND c_id='$id'";
...
<?php
      ...
      $sqlCreditSelected = "SELECT * FROM tbl_customer_pay WHERE pi_date = '$Date' c_id='$id'";
